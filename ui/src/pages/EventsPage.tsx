  ...
  return (
    <div className="min-h-screen bg-cream-50">
      <PageHeader
        ...
        title={<>The neighborhood, <em className="text-gold-300">in motion.</em></>}
        subtitle="Meetings, festivals, clean-ups, and everything in between. RSVP, show up, earn your stripes."
      />
